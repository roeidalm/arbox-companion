...
ACTIONS = {
    ...
    "rule_save": ("POST", "/rules", None, {"id", "name", "enabled", "coaches", "categories", "weekdays", "time_from", "time_to", "mode", "recurrence_weeks", "recurrence_anchor", "confirm_unmatched"}),
    "rule_skip_period": ("POST", "/rules/{id}/skip-period", "rule_id", {"period_start"}),
