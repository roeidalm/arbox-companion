...
for name in ('brand/icon.svg', 'feedback-form.js', 'feedback.css', 'membership-policy.js', 'membership-ui.js', 'membership-ui.css', 'membership-choice.js', 'filter-picker.js'):
